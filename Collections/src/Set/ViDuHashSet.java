...
public class ViDuHashSet {
	// HashSet => thêm vào các giá trị không trùng nhau và in ra không sắp xếp theo thứ tự
	Set<String> ThungPhieu = new HashSet<String>();

	public ViDuHashSet() {
	}
	
	/// Đa số trả về kiểu dữ liệu boolean, 1 vài trường hợp void hoặc int, ...
	//  Hàm add => thêm giá trị trong Set
